...
class RetrievalService:
    ...
    def retrieve(self, publication: Publication) -> str | None:
        """
        ...
        Args:
            publication: Publication to retrieve
    ...
    def retrieve_batch(
        ...
        Returns:
            Dict mapping DOI/ID to text content
        """
        results: dict[str, str | None] = {}
        
        for pub in publications:
            key = pub.doi or pub.openalex_id or pub.title
            results[key] = self.retrieve(pub)
        ...
        try:
            with httpx.Client(follow_redirects=True, timeout=30.0) as client:
                ...
                if "application/pdf" in response.headers.get("content-type", ""):
                    ...
                    logger.warning(f"Response is not PDF: {url}")
                    return None
